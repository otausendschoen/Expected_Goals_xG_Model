...
# FIFA World Cup Heatmaps

Load libraries and Competitions using StatsBomb (only FIFA Men's World Cup)
...
**Shot Density Map in the FIFA World Cup (1970 vs. 2022):** In this analysis, we group shots into a 10x10 meter grid and examine how shooting patterns have evolved in the FIFA World Cup (1970 vs. 2022).
...
Messi mostly takes his shots from inside or near the penalty area, rarely venturing outside the box. This suggests he favors close-range finishing over long-distance attempts, and his goals—highlighted with red arrows—are primarily clustered around the center of the penalty area.
...
In 1970, Brazil relied more on long-range shooting and varied attempts, whereas in 2022, their shot selection improved by favoring higher xG opportunities inside the penalty box, reflecting modern football trends that prioritize efficiency over volume.
